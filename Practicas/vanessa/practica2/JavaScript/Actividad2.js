...
//}
//else {
   // Console.log(`No cumple con la moayoria de edad`)
//}
...
//if (age >= 18 && credencial) {
 // console.log(`Es mayor de edad y cuenta con credencial`);
//} else {
 // console.log(`Es menor de edad y no cuenta con credencial`);
//}
